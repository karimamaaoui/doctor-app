...
@Component({
    ...
    standalone: true,
    imports: [MatFormFieldModule, MatInputModule, MatTableModule, MatSortModule, MatPaginatorModule, FeathericonsModule],
    templateUrl: './dtw-sorting-pagination-filtering.component.html',
    styleUrl: './dtw-sorting-pagination-filtering.component.scss'
})
export class DtwSortingPaginationFilteringComponent implements AfterViewInit {
